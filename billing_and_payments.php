...
if ($conn) {
    ...
    <a href="lawfirm_home.php?page=billing_and_payments&action=create_invoice" class="btn btn-success">Create Invoice</a>
...
<?php
    // Check if the action is 'create_invoice' and include the file
